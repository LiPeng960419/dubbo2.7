package com.lipeng.common.utils.twitter;
 ...
 * 加起来刚好64位，为一个Long型。<br> SnowFlake的优点是，整体上按照时间自增排序，并且整个分布式系统内不会产生ID碰撞(由数据中心ID和机器ID作区分)，并且效率较高，经测试，
...
public class SnowflakeIdWorker {
     ...
     * 开始时间截 (2019-01-01)
     */
    private static final long twepoch = 1549011420217L;
    ...
    public SnowflakeIdWorker(long workerId, long dataCenterId) {
        ...
        if (dataCenterId > maxDataCenterId || dataCenterId < 0) {
            throw new IllegalArgumentException(
                    String.format("dataCenterId can't be greater than %d or less than 0",
                            maxDataCenterId));
        }
